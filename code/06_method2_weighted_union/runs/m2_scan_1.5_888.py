...
np.save('F:/tmp/m2_final_pre_alpha1.5_seed888.npy', lab)
...
print(json.dumps({"alpha":1.5,"seed":888,"drg_overlap":ov["Dorsal root ganglion"],"sc_overlap":ov["Spinal cord"],"sc_all_together":sc_all_together,"sc_own_pre":sc_own_pre,"n_clusters":m["n_clusters"],"ari":m["ari"],"nmi":m["nmi"],"silhouette":m["silhouette"],"coherence":m["coherence"],"label_sha256":sha}))
